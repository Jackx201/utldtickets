...
define('SECRET_SALT','0LvyFhXdP1MHpq5TPWst3ESSqJZebMeh');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','logosticket@hotmail.com');
...
define('DBNAME','respaldoutldtickets');
define('DBUSER','root');
define('DBPASS','QpsT!ssNjK27');
