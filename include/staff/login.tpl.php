...
<!-- <div class="card bg-light mb-3" style = "margin-top: 5%">
  <div class="card-header"> ¿Tienes un problema? </div>
  <div class="card-body">
    
    <p class="card-text">Este formulario es exclusivo para el equipo de soporte, si eres un alumno, docente,
        personal administrativo y quieres <strong>reportar un problema</strong>, entonces haz clic aquí.</p>
  </div>
</div> -->
    ...
    <div id="company">
        <div class="content">
            ...
            Si quieres <strong> reportar un problema <strong> <a href="../index.php" style="text-decoration: underlined; color: #3DE599;">haz clic aquí.</a>
        </div>
    </div>
</div>
<!-- <div id="poweredBy"><?php echo __('Powered by'); ?>
    <a href="https://utlagunadurango.edu.mx/index.php/es/" target="_blank">
