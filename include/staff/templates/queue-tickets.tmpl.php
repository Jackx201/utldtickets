...
<?php
    ...
    // echo "<td id='boton'> <button type='button' style='background-color: yellowgreen; border-radius: 7px; border: solid 2px #323232 ;' value =". $T['ticket_id'] . " >
    // <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='white' class='bi bi-check-circle' viewBox='0 0 17 15'>
...
function redirect() {
    let idticket = this.value;

    let url = "http://172.16.100.45:8080/inventario?ticket=" + idticket;
		let params = "width=1800,height=1800,scrollbars=NO";

		window.open( url, "formPrestamo" , params);
