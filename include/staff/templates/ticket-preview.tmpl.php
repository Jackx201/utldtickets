<!-- <link rel="stylesheet" href="../tooltype.css"> -->
<?php
/*
...
echo '
        <li class="active"><a id="preview_tab" href="#preview"
            ...
            echo '
            <li class="collab_tab"><a id="preview_tab" class = "hrr" href="#herramientas"
                ><i class="icon-list-alt"></i>&nbsp;Herramientas</a>
            </li>';
...
<div class="hidden tab_content thread-preview" id="herramientas">



<h2 id="headersol">Herramientas Solicitadas:</h2>
<?php $ticketid = $ticket->getId() ?>
<!-- <h2>Este es el ticket: <?php echo($ticketid); ?></h2> -->
<h2 id="na">No se han solicitado herramientas en este ticket.</h2>
<?php
    ...
    INNER JOIN detalle_peticion ON detalle_peticion.peticion_id = peticiones.id 
    INNER JOIN catalogo ON catalogo.id = detalle_peticion.herramienta
    WHERE ticket_id = $ticketid";
    $result = $conn->query($sql);

    echo(" <table width='400' class='bordered' cellpadding='1' cellspacing='0' id = 'tablesol'> ");
    echo(" 
    <tr> 
    <th>Herramienta</th>
    <th style = 'text-align: center'>Cantidad</th>
     ...
     while($row = $result->fetch_assoc()) {
       ...
       <td style = 'text-align: center'>".$row["qty_peticion"]."</td>
       </tr>";
     }
     echo("</table>");
?>
...
<script>
    ...
    if(spanContent.innerHTML.includes("Valeria")){
        ...
        document.getElementById('headersol').style.display = 'none';
        document.getElementById('tablesol').style.display = 'none';
